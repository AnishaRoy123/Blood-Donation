 ...
 <style>
  ...
  <div class="container">
    ...
    <br><form action="" method="post">
      <div class="dropdown">
        <h4 id="ser">Search category</h4>
        <select class="form-select row" id="choose" name="cat">
...
<table class="table table-dark table-striped">
    ...
    <?php
       if(isset($_POST['search']))
       {
        ...
        $responce =getAllDonorsByGrou($cat);
        //echo "Records ".mysqli_num_rows($responce);
          if(mysqli_num_rows($responce)>0)
          {
              while($data = mysqli_fetch_assoc($responce))
              {
                  ...
                  <td  class="table-light " style=" background-color: aquamarine; border: 1px solid black;
                  border-collapse: collapse;">'.$data['cat'].'</td>   
                 
                  <td  class="table-light" style=" background-color: aquamarine; border: 1px solid black;
                  border-collapse: collapse;">'.$data['image'].'</td> 
                  <td class="table-light" style=" background-color: aquamarine; border: 1px solid black;
                  border-collapse: collapse;">'.$data['price'].'</td> 
